...
if __name__ == '__main__':
    ...
    stopwords_f.close()
    Index = index_docs(sys.argv[1], stop_words)
    #create an index for all terms in <text>, data structure {'w1':{'ID1':2, 'ID2':1}, 'w2':{'ID3':1, 'ID1':3}}
    ...
    print('Index of documents in the \data folder ------')
    print(Index)
